...
ZIPNAME="Neko-lite-AOSP-Ginkgo-$(TZ=Asia/Jakarta date +"%Y%m%d-%H%M").zip"
ZIPNAME_KSU="Neko-lite-AOSP-Ginkgo-KSU-$(TZ=Asia/Jakarta date +"%Y%m%d-%H%M").zip"
...
sed -i 's/CONFIG_LOCALVERSION="-Neko-lite"/CONFIG_LOCALVERSION="-Neko-lite-KSU"/g' arch/arm64/configs/vendor/ginkgo-perf_defconfig
else
