...
ZIPNAME="Merry-Goo-ginkgo-$(TZ=Asia/Kolkata date +"%Y%m%d-%H%M").zip"
ZIPNAME_KSU="Merry-Goo-ginkgo-KSU-$(TZ=Asia/Kolkata date +"%Y%m%d-%H%M").zip"
...
sed -i 's/CONFIG_LOCALVERSION="-Merry-Goo"/CONFIG_LOCALVERSION="-Merry-Goo-KSU"/g' arch/arm64/configs/vendor/ginkgo-perf_defconfig
else
