...
ZIPNAME="Nightmare-v1.0-ginkgo-$(TZ=Asia/Kolkata date +"%Y%m%d-%H%M").zip"
ZIPNAME_KSU="Nightmare-v1.0-ginkgo-KSU-$(TZ=Asia/Kolkata date +"%Y%m%d-%H%M").zip"
...
sed -i 's/CONFIG_LOCALVERSION="-Nightmare-v1.0"/CONFIG_LOCALVERSION="-Nightmare-v1.0-KSU"/g' arch/arm64/configs/vendor/ginkgo-perf_defconfig
else
